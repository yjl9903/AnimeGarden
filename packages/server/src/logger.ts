/**
 * Copy from https://github.com/withastro/astro/blob/main/packages/astro/src/core/logger/core.ts
 */

import stringWidth from 'string-width';
import { blue, bold, dim, red, yellow } from '@breadc/color';
...
export const logger = new Logger({ dest: consoleLogDestination, level: 'info' });
