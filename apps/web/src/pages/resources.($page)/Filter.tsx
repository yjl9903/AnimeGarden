...
import { addCollectionItem } from '~/stores/collection';
...
export function FilterOperations(props: Props) {
  ...
  const collection = useSelector(stores.currentCollectionStore);
  ...
  const addToCollection = useCallback(() => {
    ...
    stores.isOpenSidebarStore.setState(() => true);

    trackAddCollection();
  }, [filter, collection, stores]);
