...
export const ThemeToggle = memo(() => {
  const { themeModeStore } = useAppStores();
  const mode = useSelector(themeModeStore);
        ...
        <div className="relative bg-gray-200 dark:bg-dark-800 rounded-full p-1 flex items-center">
          ...
          <button
            ...
            className={clsx(
              ...
              mode === 'light'
                ? 'bg-white dark:bg-transparent shadow-sm transform scale-105'
          ...
          <button
            ...
            className={clsx(
              ...
              mode === 'system'
                ? 'bg-white dark:bg-dark-100 shadow-sm transform scale-105'
                : 'hover:bg-gray-100 dark:hover:bg-dark-300'
            )}
          >
            <svg
          ...
          <button
            ...
            className={clsx(
              'w-5 h-5 rounded-full flex items-center justify-center transition-all duration-200 cursor-pointer',
              mode === 'dark'
                ? 'bg-transparent dark:bg-dark-100 shadow-sm transform scale-105'
                : 'hover:bg-gray-100 dark:hover:bg-dark-300'
            )}
          >
            <svg
